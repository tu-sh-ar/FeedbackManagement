...
router.get("/", jwt_auth_1.verifyToken, feedback_template_controller_1.getTemplates);
// new template
router.post("/", jwt_auth_1.verifyToken, feedback_template_controller_1.createTemplate);
//update template
router.put("/:id", 
//verifyToken,
schema_validations_1.Validate.checkFeedbackTemplate, schema_validations_1.validateSchema, feedback_template_controller_1.updateTemplate);
